...
<body>
    ...
    <section class="wrapper">
        <div class="top">Peliculas</div>
        <div class="bottom" aria-hidden="true">Peliculas</div>
    </section>
    ...
    <div class="selectores">
        ...
        <a id='creacion' href='<?php if(isset($_SESSION['id'])){echo"creacionpelicula/crear.php";}else{echo"../../user/loginRegister/login/login.php";}; ?>'><button>+</button></a>
    </div>
    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($opcion2 == 1) {
                if($opcion == 1){
                    include "fetch/peliculafetchold.php";
                }elseif($opcion == 2){
                    include "fetch/peliculafetchname.php";
                }elseif($opcion == 3){
                    include "fetch/peliculafetchauth.php";
                }elseif($opcion == 4){
                    include "fetch/peliculafetchrating.php";
                }elseif($opcion == 0){
                    include "fetch/peliculafetch.php";
                }
            } elseif ($opcion2 == 2) {
                if($opcion == 1){
                    include "fetch/peliculafetchold.php";
                ...
                if($opcion == 1){
                    include "fetchnowhere/peliculafetchold.php";
                }elseif($opcion == 2){
                    include "fetchnowhere/peliculafetchname.php";
                }elseif($opcion == 3){
                    include "fetchnowhere/peliculafetchauth.php";
                }elseif($opcion == 4){
                    include "fetchnowhere/peliculafetchrating.php";
                }elseif($opcion == 0){
                    include "fetchnowhere/peliculafetch.php";
                }
            }
        }else{
            include "fetchnowhere/peliculafetch.php";
