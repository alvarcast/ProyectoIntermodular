...
<body>
    ...
    <section class="wrapper">
        <div class="top">Videojuegos</div>
        <div class="bottom" aria-hidden="true">Videojuegos</div>
    </section>
    ...
    <div class="selectores">
        ...
        <a id='creacion' href='<?php if(isset($_SESSION['id'])){echo"creacionvideojuego/crear.php";}else{echo"../../user/loginRegister/login/login.php";}; ?>'><button>+</button></a>
    </div>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($opcion2 == 1) {
                ...
                if($opcion == 1){
                    ...
                    include "fetchnowhere/videojuegofetchname.php";
                }elseif($opcion == 3){
                    include "fetchnowhere/videojuegofetchauth.php";
                }elseif($opcion == 4){
                    include "fetchnowhere/videojuegofetchrating.php";
                }elseif($opcion == 0){
                    include "fetchnowhere/videojuegofetch.php";
                }
            }
        }else{
            include "fetchnowhere/videojuegofetch.php";
